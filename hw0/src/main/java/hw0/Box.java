...
public class Box implements Iterable<Ball> {
    ...
    public boolean add(Ball b) {
        // Your code goes here.  Remove the exception after you're done.
        if ((ballContainer.contains(b)) || ((ballContainer.getVolume() + b.getVolume()) > maxCapacity)) {
            return false;
        }
        ballContainer.add(b);
        return true;
    ...
    public Iterator<Ball> getBallsFromSmallest() {
        ...
        Collections.sort(newlist, Comparator.comparingDouble(Ball::getVolume));
        Iterator<Ball> it2 = newlist.iterator();
        return it2;
    }

    /**
     * This is my comparator function that will sort the set of balls in ascending
     * order. It will override the compareTo method.
    */
