...
public final class GraphTest{
    ...
    private Graph<String, String> createRandomGraph(int randomNum){
    ...
    // add edges to graph
    private void addEdges(Graph<String, String> graph, int randomNum){
    ...
    private void addRandomEdges(Graph<String, String> graph, int randomNum){
        for (int i = 0; i < randomNum-1; i++){
    ...
    public void testConstructor() {
        ...
        Graph<String, String> testEmptyGraph = new Graph<>();
        assertTrue(testEmptyGraph.equals(Graph.emptyGraph));
    }
    ...
    public void testAddMultipleEdges(){
        ...
        Graph<String, String> testGraph = createRandomGraph(randomNum);
    ...
    public void testBiggerListNodes(){
        ...
        Graph<String, String> testGraph = createRandomGraph(randomInt);
